...
export default class NinePatch extends Phaser.GameObjects.Group {
    ...
    init(x, y, width, height) {
        ...
        this.spriteTR = this.scene.add.sprite(x + this.data.textureCornerWidth + midWidth, y, this.data.textureName, 'frmTR');
        this.spriteML = this.scene.add.sprite(x + 0, y + this.data.textureCornerHeight, this.data.textureName, 'frmML');
        this.spriteM = this.scene.add.sprite(x + this.data.textureCornerWidth, y + this.data.textureCornerHeight, this.data.textureName, 'frmM');
        this.spriteMR = this.scene.add.sprite(x + this.data.textureCornerWidth + midWidth, y + this.data.textureCornerHeight, this.data.textureName, 'frmMR');
        this.spriteBL = this.scene.add.sprite(x + 0, y + midHeight + this.data.textureCornerHeight, this.data.textureName, 'frmBL');
        this.spriteB = this.scene.add.sprite(x + this.data.textureCornerWidth, y + midHeight + this.data.textureCornerHeight, this.data.textureName, 'frmB');
        this.spriteBR = this.scene.add.sprite(x + this.data.textureCornerWidth + midWidth, y + midHeight + this.data.textureCornerHeight, this.data.textureName, 'frmBR');
        this._bounds = new Phaser.Geom.Rectangle(x, y, midWidth + 2 * this.data.textureCornerWidth, midHeight + 2 * this.data.textureCornerHeight);
    ...
    addFrames(textureName) {
        ...
        texture.add('frmT', 0, this.data.textureCornerHeight, 0, textureWidthMinusTwoCorners, this.data.textureCornerHeight);
        texture.add('frmTR', 0, textureWidthMinusOneCorner, 0, this.data.textureCornerWidth, this.data.textureCornerHeight);
        texture.add('frmML', 0, 0, this.data.textureCornerHeight, this.data.textureCornerWidth, textureHeightMinusTwoCorners);
        texture.add('frmM', 0, this.data.textureCornerWidth, this.data.textureCornerHeight, textureWidthMinusTwoCorners, textureHeightMinusTwoCorners);
        texture.add('frmMR', 0, textureWidthMinusOneCorner, this.data.textureCornerHeight, this.data.textureCornerWidth, textureHeightMinusTwoCorners);
        texture.add('frmBL', 0, 0, textureHeightMinusOneCorner, this.data.textureCornerWidth, this.data.textureCornerHeight);
        texture.add('frmB', 0, this.data.textureCornerWidth, textureHeightMinusOneCorner, textureWidthMinusTwoCorners, this.data.textureCornerHeight);
        texture.add('frmBR', 0, textureWidthMinusOneCorner, textureHeightMinusOneCorner, this.data.textureCornerWidth, this.data.textureCornerHeight);
    }
